...
public class FilteringParser extends Parser<Writer> {
	...
	public FilteringParser(Writer writer, Function<String, String> filter) {
		super(false);
		this.writer = writer;
	...
	public static Writer parse(Reader reader, Writer writer, Function<String, String> filter) throws ParserException {
    	FilteringParser me = new FilteringParser(writer, filter);
